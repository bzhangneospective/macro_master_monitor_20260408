...
# ==========================================
st.set_page_config(
    page_title="Macro Terminal V3.16 (Inventory Subplot)", 
    layout="wide", 
...
if db:
    ...
    def get_data(asset_name):
        ...
        mapping = {
            ...
            "China 1Y Yield": (mk_df.get('China_1Y_Yield'), "#FFD700", True, "%"), "China 2Y Yield": (mk_df.get('China_2Y_Yield'), "#FF6347", True, "%"), "China 10Y Yield": (mk_df.get('China_10Y_Yield'), "#FF4B4B", True, "%"),
            
            "Germany 10Y Bond": (yf_df.get('DE10Y=RR'), "#00CC96", True, "%"), "UK 10Y Bond": (yf_df.get('GB10Y=RR'), "#8A2BE2", True, "%"), "France 10Y Bond": (yf_df.get('FR10Y=RR'), "#1E90FF", True, "%"), "Italy 10Y Bond": (yf_df.get('IT10Y=RR'), "#FF4B4B", True, "%"), "Spain 10Y Bond": (yf_df.get('ES10Y=RR'), "#FFA500", True, "%"), "Japan 10Y Bond": (yf_df.get('JP10Y=RR'), "#FFC0CB", True, "%"),
